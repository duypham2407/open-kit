...
const NEXT_ACTION_BY_STAGE = {
  ...
  full_product: "Define the problem, scope, business rules, and acceptance expectations.",
  full_solution: "Choose the technical approach, sequencing, and validation strategy.",
  full_implementation: "Execute the approved plan and keep task-board state honest.",
  full_code_review: "Check spec compliance first, then code quality before QA begins.",
