...
> Historical design note: this document reflects an earlier planning phase and is kept for audit/history only. Use current runtime docs and release notes for the active contract.
