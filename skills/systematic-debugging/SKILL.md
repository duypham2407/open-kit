...
List 2-3 hypotheses. Then narrow them down using the **Grep tool** (built-in), **`tool.semantic-search`**, **`tool.find-references`**, and **Read tool** until you identify the most likely root cause.
