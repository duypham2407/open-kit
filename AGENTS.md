...
- `/init-deep` is now the current runtime-backed repository-guidance command; it analyzes repository signals and refreshes project-owned root `AGENTS.md` content while leaving `.opencode/openkit/AGENTS.md` as the OpenKit-managed compatibility guide
