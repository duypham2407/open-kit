...
- Follow `context/core/tool-substitution-rules.md` whenever continuation diagnosis requires reading or searching code.
- Use `context/core/runtime-surfaces.md` to distinguish workflow closure from runtime continuation control.
