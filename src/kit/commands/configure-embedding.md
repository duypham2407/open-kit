...
When inspecting repository code or runtime surfaces during embedding setup, follow `context/core/tool-substitution-rules.md` and prefer kit intelligence tools before basic built-in tools or OS commands.
