...
test("command and runtime guidance align to options-in-quick_plan contract", () => {
  ...
  const instructionContracts = readProjectFile("runtime/instruction-contracts.js")
  const runtimeGuidance = readProjectFile("openkit-runtime/lib/runtime-guidance.js")
