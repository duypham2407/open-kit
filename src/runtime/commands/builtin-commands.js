export function listBuiltinRuntimeCommands() {
  return [
    ...
    { id: 'runtime-command.init-deep', name: '/init-deep', path: 'commands/init-deep.md', handler: 'runtime-command.init-deep' },
    ...
    { id: 'runtime-command.handoff', name: '/handoff', path: 'commands/handoff.md' },
    { id: 'runtime-command.stop-continuation', name: '/stop-continuation', path: 'commands/stop-continuation.md' },
  ];
}
