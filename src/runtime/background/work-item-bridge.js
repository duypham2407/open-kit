export function createWorkItemBridge({ projectRoot, workflowKernel = null }) {
  return {
    projectRoot,
    workflowKernel,
    ...
    onRunCompleted({ runId, workflowRunId = null, output = null, taskId = null, workItemId = null, customStatePath = null }) {
      if (!workflowKernel) {
        return null;
      }
    ...
    onRunCancelled({ runId, workflowRunId = null, customStatePath = null }) {
      if (!workflowKernel) {
        return null;
      }
