...
export const COMMAND_INSTRUCTION_CONTRACTS = {
  ...
  'quick-task': {
    ...
    nextAction: 'Quick Agent reads the codebase, confirms understanding and analyzes options in quick_plan (brainstorm happens inline), produces a selected-option plan, and tests after explicit plan confirmation.',
