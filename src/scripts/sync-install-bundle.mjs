...
import { OPENKIT_ASSET_MANIFEST, createDerivedSkillCatalog } from '../install/asset-manifest.js';

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const projectRoot = path.resolve(__dirname, '..', '..');
const skillCatalogPath = path.join(projectRoot, 'src/assets/install-bundle/opencode/skill-catalog.json');
